"""
Django settings for dotacia project.
...
SECRET_KEY = '&kbikt8!r!*t#z7&lgc@)a-8+0du2ia!+e-*mc%*b$9j5#z)qn'
...
WSGI_APPLICATION = 'dotacia.wsgi.application'
